...
Project-level decisions are logged as AD-001…AD-016 in [`.specs/STATE.md`](.specs/STATE.md). Questions raised
while implementing, together with the assumption applied so work never blocked, are in
...
Every other open question, with the assumption applied, is listed in [`CLARIFY.md`](CLARIFY.md).
