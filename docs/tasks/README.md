...
One document per task, functional + technical description each. Canonical execution index (order, dependencies, test coverage matrix, gates, validation tables): `.specs/features/room-wall-selection/tasks.md`. Sources: `.specs/features/room-wall-selection/spec.md`, `design.md`, `.specs/STATE.md` (AD-001..AD-016).
...
29 tasks; 24/24 spec requirements mapped.
